...
public class ApplicationDeleteSupplierException {
    ...
    public ResponseEntity<String> handleSupplierDeletionException(SupplierDeletionException e) {
        ...
        return new ResponseEntity<>("Error occurred while deleting supplier: ".concat(e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<String> handleException(Exception e) {
        ...
        // Return an error response with appropriate status code
        return new ResponseEntity<>("An unexpected error occurred: ".concat(e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
