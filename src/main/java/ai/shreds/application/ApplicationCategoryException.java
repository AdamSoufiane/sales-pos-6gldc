package ai.shreds.application; 
 ...
 public class ApplicationCategoryException { 
     ...
     // Add a more specific exception handler for custom exceptions related to category operations 
     ...
     // Add a more specific exception handler for validation exceptions 
