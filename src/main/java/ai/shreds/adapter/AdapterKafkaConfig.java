...
public class AdapterKafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, SharedAdapterProductAddedEventDTO> consumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, SharedAdapterProductAddedEventDTO.class.getName());
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(SharedAdapterProductAddedEventDTO.class));
    }
}