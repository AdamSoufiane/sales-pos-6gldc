...
import ai.shreds.adapter.request.AdapterCreateSupplierRequest;
import ai.shreds.adapter.request.AdapterUpdateSupplierRequest;
import ai.shreds.adapter.response.AdapterSupplierResponse;
import ai.shreds.adapter.response.AdapterDeleteSupplierResponse;
