package ai.shreds.infrastructure; 
 ...
 public class InfrastructureSupplierRepositoryImpl implements DomainSupplierRepositoryPort { 
     ...
     public DomainSupplierEntity findById(Long id) { 
         ...
         Optional<DomainSupplierEntity> supplier = Optional.ofNullable(entityManager.find(DomainSupplierEntity.class, id)); 
         DomainSupplierEntity result = supplier.orElseThrow(() -> new SupplierNotFoundException("Supplier not found.")); 
         logger.info("Found supplier: {}", result); 
         return result; 
     } 
 } 
