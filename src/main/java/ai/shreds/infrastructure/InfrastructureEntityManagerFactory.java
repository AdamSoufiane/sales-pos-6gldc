...
public class InfrastructureEntityManagerFactory {
    ...
    public InfrastructureEntityManagerFactory(Environment env) {
        this.env = env;
    }
    ...
    public DataSource dataSource() {
        try {
            ...
            throw new RuntimeException("DataSource creation failed: " + e.getMessage(), e);
        }
    }
    ...
    public EntityManagerFactory entityManagerFactory() {
        try {
            ...
            throw new RuntimeException("EntityManagerFactory creation failed: " + e.getMessage(), e);
        }
    }
