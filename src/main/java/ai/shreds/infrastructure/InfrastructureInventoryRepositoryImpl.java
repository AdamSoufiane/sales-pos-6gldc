 ...
 public class InfrastructureInventoryRepositoryImpl implements DomainInventoryRepositoryPort { 
     ...
     public void save(DomainInventoryEntity entity) { 
         try { 
             ...
             logger.error("Failed to save inventory entity", e); 
             throw new InfrastructureException("Failed to save inventory entity", e); 
         } 
     } 
     ...
     public DomainInventoryEntity findByProductId(String productId) { 
         try { 
             ...
             logger.error("Failed to find inventory entity by productId", e); 
             throw new InfrastructureException("Failed to find inventory entity by productId", e); 
         } 
     } 
 } 
